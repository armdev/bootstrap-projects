...
| secured-vx-http
| secured-vx-http-myproject.LOCAL_OPENSHIFT_HOSTNAME
|
| secured-vx-http
| <all>
|
...
You can interact with the booster using the form at the secured endpoint URL and the link:http://appdev.openshift.io/docs/vertx-runtime.html#sso-users[provided users].
